...
include two diagnostic columns next to the candidate and reference values:
`<col>__absdiff`, the measured absolute deviation, and `<col>__thresh`, the
threshold that was applied. These are computed for the failing columns only,
